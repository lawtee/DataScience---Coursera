...
Mean: `r average_daily_mean`    
Median: `r average_daily_median`.   
...
```
The 5-minute interval which contains the maximum number of steps is `r average_interval_steps_max`. 
...
The total number of missing values in the dataset is `r number_row_NA`. 
...
Mean: `r average_daily_mean_new` 
Median: `r average_daily_median_new`.   
...
Mean(Old-new): `r mean_diff`   
Median(Old-new): `r median_diff` 
